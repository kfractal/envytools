...
#include "gm20b/dev_bus.h"
#include "gm20b/dev_ce2_pri.h"
#include "gm20b/dev_fifo.h"
#include "gm20b/dev_ce2_pri.h"
#include "gm20b/dev_ctxsw_prog.h"
#include "gm20b/dev_fb.h"
#include "gm20b/dev_fifo.h"
#include "gm20b/dev_flush.h"
#include "gm20b/dev_fuse.h"
#include "gm20b/dev_graphics_nobundle.h"
#include "gm20b/dev_ltc.h"
#include "gm20b/dev_master.h"
#include "gm20b/dev_mmu.h"
#include "gm20b/dev_pbdma.h"
#include "gm20b/dev_pri_ringmaster.h"
#include "gm20b/dev_pri_ringstation_sys.h"
#include "gm20b/hwproject.h"
#include "gm20b/dev_pwr_pri.h"
#include "gm20b/dev_ram.h"
#include "gm20b/dev_therm.h"
#include "gm20b/dev_top.h"
#include "gm20b/dev_trim.h"
#include "gm20b/dev_timer.h"

/* some header elements added after final chip def'n */
#ifndef NV_CTXSW_MAIN_IMAGE_PRIV_ACCESS_MAP_CONFIG
#include "gm20b/dev_ctxsw_prog_addendum.h"
#endif
...
static void emit_fifo_group()
{
    ...
    emit_field   ( F_SPEC( sched_error, NV_PFIFO_INTR_EN_0_SCHED_ERROR, "m") );
...
{
    begin_group( GAUX_SPEC( gmmu, NV_MMU ) );
...
{
    begin_group( G_SPEC( pri_ringmaster, NV_PPRIV_MASTER ) );
    emit_register( R_SPEC( ring_command, NV_PPRIV_MASTER_RING_COMMAND ) );
...
{
    begin_group( GAUX_SPEC( proj, NV_DUMMY ) );
...
{
    begin_group( GAUX_SPEC( ram, NV_RAMIN ) );

    begin_scope( S_SPEC( in, NV_RAMIN ) ); /* ram_in */
