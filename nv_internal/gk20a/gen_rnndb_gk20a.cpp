...
#include "gk20a/dev_bus.h"
#include "gk20a/dev_ce2_pri.h"
#include "gk20a/dev_fifo.h"
#include "gk20a/dev_ctxsw_prog.h"
#include "gk20a/dev_fb.h"
#include "gk20a/dev_fifo.h"
#include "gk20a/dev_flush.h"
#include "gk20a/dev_graphics_nobundle.h"
#include "gk20a/dev_ltc.h"
#include "gk20a/dev_master.h"
#include "gk20a/dev_mmu.h"
#include "gk20a/dev_pbdma.h"
#include "gk20a/dev_pri_ringmaster.h"
#include "gk20a/dev_pri_ringstation_sys.h"
#include "gk20a/hwproject.h"
#include "gk20a/dev_pwr_pri.h"
#include "gk20a/dev_ram.h"
#include "gk20a/dev_therm.h"
#include "gk20a/dev_top.h"
#include "gk20a/dev_trim.h"
#include "gk20a/dev_timer.h"

/* some header elements added after final chip def'n */
#ifndef NV_CTXSW_MAIN_IMAGE_PRIV_ACCESS_MAP_CONFIG
#include "gk20a/dev_ctxsw_prog_addendum.h"
#endif
...
{
    begin_group( GAUX_SPEC( gmmu, NV_MMU ) ); // this isn't a real "domain".  
...
{
    begin_group( G_SPEC( priv_master, NV_PPRIV_MASTER ) );
    ...
    emit_register( R_SPEC( ring_command_data, NV_PPRIV_MASTER_RING_COMMAND_DATA ) );

    emit_register( R_SPEC( ring_start_results, NV_PPRIV_MASTER_RING_START_RESULTS ) );
    ...
    emit_register( R_SPEC( ring_intr_status0, NV_PPRIV_MASTER_RING_INTERRUPT_STATUS0 ) );

    emit_register( R_SPEC( ring_intr_status1, NV_PPRIV_MASTER_RING_INTERRUPT_STATUS1 ) );

    emit_register( R_SPEC( ring_global_ctl, NV_PPRIV_MASTER_RING_GLOBAL_CTL ) );
    ...
    emit_register( R_SPEC( ring_enum_fbp, NV_PPRIV_MASTER_RING_ENUMERATE_RESULTS_FBP ) );
...
{
    begin_group( G_SPEC( priv_sys, NV_PPRIV_SYS ) );

    emit_register(IR_SPEC( master_sm_config, NV_PPRIV_SYS_MASTER_SM_CONFIG) );

    emit_register( R_SPEC( priv_decode_config, NV_PPRIV_SYS_PRIV_DECODE_CONFIG ) );
